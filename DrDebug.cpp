...
DrDebug::DrDebug(QWidget *parent) : QWidget(parent)
{
  ...
  connect(btn, &QPushButton::clicked, this, [this]() {
    ...
    std::array<dr_player_t, 4> players = {{
      ...
      { DR_CHARACTER_WARIO, DR_CONTROL_PORT_P2, DR_CONTROL_TYPE_HUMAN,   DR_DIFFICULTY_VERY_HARD, DR_TEAM_COLOR_BLUE, DR_TEAM_TYPE_4P, 1 },
      { DR_CHARACTER_YOSHI, DR_CONTROL_PORT_P3, DR_CONTROL_TYPE_HUMAN,   DR_DIFFICULTY_EASY,      DR_TEAM_COLOR_BLUE, DR_TEAM_TYPE_4P, 2 },
      { DR_CHARACTER_LUIGI, DR_CONTROL_PORT_P4, DR_CONTROL_TYPE_HUMAN,   DR_DIFFICULTY_NORMAL,    DR_TEAM_COLOR_BLUE, DR_TEAM_TYPE_4P, 3 },
    }};
