...
static const dr_mp_minigame_t MP6_MINIGAMES[] = {
  ...
  { "Shoot Yer Mouth Off", DR_MINIGAME_1V3, 0x41, 0x47, DR_NO_QUIRKS, DR_FLAG_MIC },
  { "Talkie Walkie", DR_MINIGAME_1V3, 0x42, 0x48, DR_NO_QUIRKS, DR_FLAG_MIC },
  { "Word Herd", DR_MINIGAME_1V3, 0x44, 0x4A, DR_NO_QUIRKS, DR_FLAG_MIC },
  { "Fruit Talktail", DR_MINIGAME_1V3, 0x45, 0x4B, DR_NO_QUIRKS, DR_FLAG_MIC },
