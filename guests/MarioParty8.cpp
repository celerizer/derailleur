...
{
  { "Speedy Graffiti", DR_MINIGAME_4P, 0x00, 0x17, { DR_QUIRK_BITS_EFB_TO_TEXTURE | DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER) }, DR_FLAG_NO_NETPLAY },
  { "Swing Kings", DR_MINIGAME_4P, 0x01, 0x18, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },
  { "Water Ski Spree", DR_MINIGAME_4P, 0x02, 0x19, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_FLAG_LUCKY },
  { "Punch-a-Bunch", DR_MINIGAME_4P, 0x03, 0x1A, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },
  ...
  { "Mosh-Pit Playroom", DR_MINIGAME_4P, 0x06, 0x1D, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Mario Matrix", DR_MINIGAME_4P, 0x07, 0x1E, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "??? - Hammer de Pokari", DR_MINIGAME_INVALID, 0x08, 0x1F, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Grabby Gridiron", DR_MINIGAME_2V2, 0x09, 0x20, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Lava or Leave 'Em", DR_MINIGAME_4P, 0x0A, 0x21, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Kartastrophe", DR_MINIGAME_4P, 0x0B, 0x22, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "??? - Ribbon Game", DR_MINIGAME_INVALID, 0x0C, 0x23, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Aim of the Game", DR_MINIGAME_BATTLE, 0x0D, 0x24, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Rudder Madness", DR_MINIGAME_4P, 0x0E, 0x25, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Gun the Runner", DR_MINIGAME_1V3, 0x0F, 0x26, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_SIDEWAYS_BUTTONS, DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Grabbin' Gold", DR_MINIGAME_1V3, 0x10, 0x27, DR_NO_QUIRKS, DR_FLAG_LUCKY },
  { "Power Trip", DR_MINIGAME_1V3, 0x11, 0x28, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_SIDEWAYS_MOTION, DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Bob-ombs Away", DR_MINIGAME_1V3, 0x12, 0x29, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Swervin' Skies", DR_MINIGAME_1V3, 0x13, 0x2A, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Picture Perfect", DR_MINIGAME_1V3, 0x14, 0x2B, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Snow Way Out", DR_MINIGAME_1V3, 0x15, 0x2C, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_FLAG_NO_NETPLAY },
  { "Thrash 'n' Crash", DR_MINIGAME_1V3, 0x16, 0x2D, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_UPRIGHT), DR_FLAG_NO_NETPLAY },
  { "Chump Rope", DR_MINIGAME_1V3, 0x17, 0x2E, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_SIDEWAYS_MOTION, DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },
  { "Sick and Twisted", DR_MINIGAME_4P, 0x18, 0x2F, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Bumper Balloons", DR_MINIGAME_2V2, 0x19, 0x30, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "Rowed to Victory", DR_MINIGAME_2V2, 0x1A, 0x31, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },
  { "Winner or Dinner", DR_MINIGAME_2V2, 0x1B, 0x32, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_FLAG_LUCKY },
  { "Paint Misbehavin'", DR_MINIGAME_2V2, 0x1C, 0x33, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Sugar Rush", DR_MINIGAME_2V2, 0x1D, 0x34, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "King of the Thrill", DR_MINIGAME_2V2, 0x1E, 0x35, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  // { "Shake It Up", DR_MINIGAME_4P, 0x1F, 0x36, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE) }, sucks
  { "Lean, Mean Ravine", DR_MINIGAME_2V2, 0x20, 0x37, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "Boo-ting Gallery", DR_MINIGAME_2V2, 0x21, 0x38, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Crops 'n' Robbers", DR_MINIGAME_2V2, 0x22, 0x39, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "In the Nick of Time", DR_MINIGAME_4P, 0x23, 0x3A, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Cut from the Team", DR_MINIGAME_BATTLE, 0x24, 0x3B, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Snipe for the Picking", DR_MINIGAME_BATTLE, 0x25, 0x3C, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Saucer Swarm", DR_MINIGAME_BATTLE, 0x26, 0x3D, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "Glacial Meltdown", DR_MINIGAME_BATTLE, 0x27, 0x3E, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },

  // { "Attention Grabber", DR_MINIGAME_DUEL, 0x28, 0x3F, DR_NO_QUIRKS }, ??
  // { "Blazing Lassos", DR_MINIGAME_DUEL, 0x29, 0x40, DR_NO_QUIRKS },

  { "Wing and a Scare", DR_MINIGAME_DUEL, 0x2A, 0x41, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Lob to Rob", DR_MINIGAME_DUEL, 0x2B, 0x42, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  // { "Pumper Cars", DR_MINIGAME_DUEL, 0x2C, 0x43, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS) }, sucks
  { "Cosmic Slalom", DR_MINIGAME_DUEL, 0x2D, 0x44, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Lava Lobbers", DR_MINIGAME_DUEL, 0x2E, 0x45, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },

  { "Loco Motives", DR_MINIGAME_DUEL, 0x2F, 0x46, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Specter Inspector", DR_MINIGAME_DUEL, 0x30, 0x47, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Frozen Assets", DR_MINIGAME_DUEL, 0x31, 0x48, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  // { "Breakneck Building", DR_MINIGAME_DUEL, 0x32, 0x49, DR_QUIRK_NATIVE_RESOLUTION }, sucks
  { "Surf's Way Up", DR_MINIGAME_DUEL, 0x33, 0x4A, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "??? - Bull Riding", DR_MINIGAME_INVALID, 0x34, 0x4B, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Balancing Act", DR_MINIGAME_INVALID, 0x35, 0x4C, DR_NO_QUIRKS, DR_NO_FLAGS }, /// @todo wut
  { "Ion the Prize", DR_MINIGAME_DUEL, 0x36, 0x4D, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "You're the Bob-omb", DR_MINIGAME_DUEL, 0x37, 0x4E, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Scooter Pursuit", DR_MINIGAME_4P, 0x38, 0x4F, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Cardiators", DR_MINIGAME_DUEL, 0x39, 0x50, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  ...
  { "Table Menace", DR_MINIGAME_SPECIAL, 0x3C, 0x53, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },
  { "Flagging Rights - TODO: nunchuk", DR_MINIGAME_INVALID, 0x3D, 0x54, DR_NO_QUIRKS, DR_NO_FLAGS }, /// @todo
  { "Trial by Tile", DR_MINIGAME_SPECIAL, 0x3E, 0x55, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Star Carnival Bowling - TODO: controls", DR_MINIGAME_INVALID, 0x3F, 0x56, DR_NO_QUIRKS, DR_NO_FLAGS }, /// @todo
  { "Puzzle Pillars", DR_MINIGAME_SPECIAL, 0x40, 0x57, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Canyon Cruisers", DR_MINIGAME_SPECIAL, 0x41, 0x58, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Chomping Frenzy", DR_MINIGAME_SPECIAL, 0x42, 0x59, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Settle It in Court", DR_MINIGAME_DUEL, 0x43, 0x5A, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Moped Mayhem", DR_MINIGAME_SPECIAL, 0x44, 0x5B, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS }, /// @todo duel
  { "Flip the Chimp", DR_MINIGAME_4P, 0x45, 0x5C, DR_WII_CONTROL(DR_WII_CONTROL_WAGGLE), DR_NO_FLAGS },

  /* Challenge -- Star Battle Arena / Duel Battles, single player. */
  { "Pour to Score", DR_MINIGAME_1P, 0x46, 0x5D, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "Fruit Picker", DR_MINIGAME_1P, 0x47, 0x5E, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_FLAG_NO_NETPLAY },
  { "Stampede", DR_MINIGAME_1P, 0x48, 0x5F, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Superstar Showdown", DR_MINIGAME_SPECIAL, 0x49, 0x60, DR_NO_QUIRKS, DR_NO_FLAGS }, // vs. Bowser (The Last)
  { "Alpine Assault", DR_MINIGAME_4P, 0x4A, 0x61, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Treacherous Tightrope", DR_MINIGAME_4P, 0x4B, 0x62, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },

  { nullptr, DR_MINIGAME_INVALID, 0xFF, 0x00, DR_NO_QUIRKS, DR_NO_FLAGS },
};
...
void MarioParty8::run()
{
  ...
  if (m_retro->readValue(&val, MP8_SCENE_ID) == DR_OK && val != m_lastScene)
  {
    ...
    if (!m_minigameActive && val == MP8_SCENE_MINIGAME_EXPLAIN)
      startMinigame();
