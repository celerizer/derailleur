...
{
  { "Speedy Graffiti", DR_MINIGAME_4P, 0x00, 0x17, { DR_QUIRK_BITS_EFB_TO_TEXTURE | DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER) }, DR_NO_FLAGS },
  ...
  { "Mario Matrix", DR_MINIGAME_4P, 0x07, 0x1E, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Aim of the Game", DR_MINIGAME_BATTLE, 0x0D, 0x24, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Rudder Madness", DR_MINIGAME_4P, 0x0E, 0x25, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Gun the Runner", DR_MINIGAME_1V3, 0x0F, 0x26, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_SIDEWAYS_BUTTONS, DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Picture Perfect", DR_MINIGAME_1V3, 0x14, 0x2B, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Snow Way Out", DR_MINIGAME_1V3, 0x15, 0x2C, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "Thrash 'n' Crash", DR_MINIGAME_1V3, 0x16, 0x2D, DR_WII_CONTROL_SPLIT(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_UPRIGHT), DR_NO_FLAGS },
  ...
  { "Bumper Balloons", DR_MINIGAME_2V2, 0x19, 0x30, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  ...
  { "Sugar Rush", DR_MINIGAME_2V2, 0x1D, 0x34, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Boo-ting Gallery", DR_MINIGAME_2V2, 0x21, 0x38, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Cut from the Team", DR_MINIGAME_BATTLE, 0x24, 0x3B, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Snipe for the Picking", DR_MINIGAME_BATTLE, 0x25, 0x3C, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Lob to Rob", DR_MINIGAME_DUEL, 0x2B, 0x42, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Loco Motives", DR_MINIGAME_DUEL, 0x2F, 0x46, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Specter Inspector", DR_MINIGAME_DUEL, 0x30, 0x47, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Trial by Tile", DR_MINIGAME_SPECIAL, 0x3E, 0x55, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Star Carnival Bowling - TODO: controls", DR_MINIGAME_INVALID, 0x3F, 0x56, DR_NO_QUIRKS, DR_NO_FLAGS }, /// @todo
  { "Puzzle Pillars", DR_MINIGAME_SPECIAL, 0x40, 0x57, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Canyon Cruisers", DR_MINIGAME_SPECIAL, 0x41, 0x58, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Chomping Frenzy", DR_MINIGAME_SPECIAL, 0x42, 0x59, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Fruit Picker", DR_MINIGAME_1P, 0x47, 0x5E, DR_WII_CONTROL_BITS(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
