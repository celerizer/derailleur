...
static const dr_mp_minigame_t SS_MINIGAMES[] =
{
  ...
  { "Fun Fun Sonic", DR_MINIGAME_4P, 0x10, SS_SUPERTYPE_NORMAL, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  { "Bucket-o-Rings", DR_MINIGAME_2V2, 0x1B, SS_SUPERTYPE_NORMAL, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  { "Ring Lasso", DR_MINIGAME_4P, 0x01, SS_SUPERTYPE_ACCIDENT, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  { "Ring of Fire", DR_MINIGAME_4P, 0x05, SS_SUPERTYPE_ACCIDENT, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Sonic Parasol", DR_MINIGAME_4P, 0x06, SS_SUPERTYPE_ACCIDENT, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Ring Tide", DR_MINIGAME_4P, 0x07, SS_SUPERTYPE_ACCIDENT, DR_NO_QUIRKS, DR_NO_FLAGS },
