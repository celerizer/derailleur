...
{
  { "Ruins Rumble", DR_MINIGAME_1V3, 0x00, 0xFF, DR_NO_QUIRKS },
  { "Hazard Hold", DR_MINIGAME_1V3, 0x01, 0xFF, DR_NO_QUIRKS },
  { "Line in the Sand", DR_MINIGAME_1V3, 0x02, 0xFF, DR_NO_QUIRKS },
  { "Block and Roll", DR_MINIGAME_1V3, 0x03, 0xFF, DR_NO_QUIRKS },
  { "Tackle Takedown", DR_MINIGAME_1V3, 0x04, 0xFF, DR_NO_QUIRKS },
  { "Weird Wheels", DR_MINIGAME_1V3, 0x05, 0xFF, DR_NO_QUIRKS },
  { "Spike-n-Span", DR_MINIGAME_1V3, 0x06, 0xFF, DR_NO_QUIRKS },
  ...
  { "Zoom Room", DR_MINIGAME_INVALID, 0x0D, 0xFF, DR_NO_QUIRKS },
  { "Cage Match", DR_MINIGAME_INVALID, 0x0E, 0xFF, DR_NO_QUIRKS },
  { "Crossfire Caverns", DR_MINIGAME_INVALID, 0x0F, 0xFF, DR_NO_QUIRKS },
  { "Bumper Sparks", DR_MINIGAME_INVALID, 0x10, 0xFF, DR_NO_QUIRKS },
  ...
  { "Skyjinks", DR_MINIGAME_4P, 0x17, 0xFF, DR_NO_QUIRKS },
  { "Player Conveyor", DR_MINIGAME_4P, 0x18, 0xFF, DR_NO_QUIRKS },
  { "Fungi Frenzy", DR_MINIGAME_4P, 0x19, 0xFF, DR_NO_QUIRKS },
  { "Jigsaw Jumble", DR_MINIGAME_4P, 0x1A, 0xFF, DR_NO_QUIRKS },
  { "Twist Ending", DR_MINIGAME_4P, 0x1B, 0xFF, DR_NO_QUIRKS },
  { "Peak Precision", DR_MINIGAME_4P, 0x1C, 0xFF, DR_NO_QUIRKS },
  { "Speeding Bullets", DR_MINIGAME_4P, 0x1D, 0xFF, DR_NO_QUIRKS },
  { "Launch Break", DR_MINIGAME_4P, 0x1E, 0xFF, DR_NO_QUIRKS },
  { "Polar Extreme", DR_MINIGAME_4P, 0x1F, 0xFF, DR_NO_QUIRKS },
  { "Logger Heads", DR_MINIGAME_4P, 0x20, 0xFF, DR_NO_QUIRKS },
  { "Smash Compactor", DR_MINIGAME_4P, 0x21, 0xFF, DR_NO_QUIRKS },
  { "Goomba Bowling", DR_MINIGAME_4P, 0x22, 0xFF, DR_NO_QUIRKS },
  { "Pianta Pool", DR_MINIGAME_4P, 0x23, 0xFF, DR_NO_QUIRKS },
  { "Bumper Bubbles", DR_MINIGAME_4P, 0x24, 0xFF, DR_NO_QUIRKS },
  { "Buddy Bounce", DR_MINIGAME_4P, 0x25, 0xFF, DR_NO_QUIRKS },
  { "Pizza Me, Mario", DR_MINIGAME_4P, 0x26, 0xFF, DR_NO_QUIRKS },
  { "Chain Event", DR_MINIGAME_4P, 0x27, 0xFF, DR_NO_QUIRKS },
  { "Pit or Platter", DR_MINIGAME_4P, 0x28, 0xFF, DR_NO_QUIRKS },
  { "Skipping Class", DR_MINIGAME_4P, 0x29, 0xFF, DR_NO_QUIRKS },
  { "Flinger Painting", DR_MINIGAME_4P, 0x2A, 0xFF, DR_NO_QUIRKS },
  { "Goomba Spotting", DR_MINIGAME_4P, 0x2B, 0xFF, DR_NO_QUIRKS },
  { "Thwomper Room", DR_MINIGAME_4P, 0x2C, 0xFF, DR_NO_QUIRKS },
  { "Ballistic Beach", DR_MINIGAME_4P, 0x2D, 0xFF, DR_NO_QUIRKS },
  { "Plunder Ground", DR_MINIGAME_4P, 0x2E, 0xFF, DR_NO_QUIRKS },
  { "Tumble Temple", DR_MINIGAME_4P, 0x2F, 0xFF, DR_NO_QUIRKS },
  { "Tuber Tug", DR_MINIGAME_4P, 0x30, 0xFF, DR_NO_QUIRKS },
  { "Piranha Patch", DR_MINIGAME_4P, 0x31, 0xFF, DR_NO_QUIRKS },
  { "Upward Mobility", DR_MINIGAME_4P, 0x32, 0xFF, DR_NO_QUIRKS },
  { "Manor of Escape", DR_MINIGAME_4P, 0x33, 0xFF, DR_NO_QUIRKS },
  { "Toad and Go Seek", DR_MINIGAME_4P, 0x34, 0xFF, DR_NO_QUIRKS },
  { "Goomba Village", DR_MINIGAME_4P, 0x35, 0xFF, DR_NO_QUIRKS },
  { "Growing Up", DR_MINIGAME_4P, 0x36, 0xFF, DR_NO_QUIRKS },
  { "Card Smarts", DR_MINIGAME_4P, 0x37, 0xFF, DR_NO_QUIRKS },
  { "Bomb Barge", DR_MINIGAME_4P, 0x38, 0xFF, DR_NO_QUIRKS },
  { "Ring Leader", DR_MINIGAME_4P, 0x39, 0xFF, DR_NO_QUIRKS },
  { "Magma Mayhem", DR_MINIGAME_4P, 0x3A, 0xFF, DR_NO_QUIRKS },
  { "Don't Look", DR_MINIGAME_4P, 0x3B, 0xFF, DR_NO_QUIRKS },
  { "Pinball Fall", DR_MINIGAME_4P, 0x3C, 0xFF, DR_NO_QUIRKS },
  ...
  { "Deck Dry Bones", DR_MINIGAME_BATTLE, 0x44, 0xFF, DR_NO_QUIRKS },
  { "Cheep Cheep Shot", DR_MINIGAME_BATTLE, 0x45, 0xFF, DR_NO_QUIRKS },
  { "Spike Strike", DR_MINIGAME_BATTLE, 0x46, 0xFF, DR_NO_QUIRKS },
  { "Bowser Jr. Breakdown", DR_MINIGAME_BATTLE, 0x47, 0xFF, DR_NO_QUIRKS },
  { "Diddy's Banana Blast", DR_MINIGAME_4P, 0x48, 0xFF, DR_NO_QUIRKS },
  { "Wiggler Bounce", DR_MINIGAME_BATTLE, 0x49, 0xFF, DR_NO_QUIRKS },
  { "Bombard King Bob-omb", DR_MINIGAME_BATTLE, 0x4A, 0xFF, DR_NO_QUIRKS },
  { "King Boo's Puzzle Attack", DR_MINIGAME_BATTLE, 0x4B, 0xFF, DR_NO_QUIRKS },
  { "Blooper Barrage", DR_MINIGAME_BATTLE, 0x4C, 0xFF, DR_NO_QUIRKS },
  { "Chain Chomp Romp", DR_MINIGAME_BATTLE, 0x4D, 0xFF, DR_NO_QUIRKS },
  { "Bowser's Block Battle", DR_MINIGAME_BATTLE, 0x4E, 0xFF, DR_NO_QUIRKS },
  { "DK's Banana Bonus", DR_MINIGAME_4P, 0x4F, 0xFF, DR_NO_QUIRKS },
