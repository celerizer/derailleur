...
static const dr_mp_minigame_t MP9_MINIGAMES[] =
{
  ...
  { "Line in the Sand", DR_MINIGAME_1V3, 0x02, 0, { DR_QUIRK_BITS_EFB_TO_TEXTURE | DR_WII_CONTROL_SPLIT_BITS(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_SIDEWAYS_BUTTONS) }, DR_NO_FLAGS },
  ...
  { "Hole Hogs", DR_MINIGAME_1V3, 0x07, 0, { DR_QUIRK_BITS_SAFE_TEXTURE_CACHE | DR_WII_CONTROL_SPLIT_BITS(DR_WII_CONTROL_POINTER, DR_WII_CONTROL_SIDEWAYS_BUTTONS) }, DR_NO_FLAGS },
  { "Pix Fix", DR_MINIGAME_1V3, 0x08, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Urn It", DR_MINIGAME_4P, 0x14, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Jigsaw Jumble", DR_MINIGAME_4P, 0x1A, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Flinger Painting", DR_MINIGAME_4P, 0x2A, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Goomba Village", DR_MINIGAME_4P, 0x35, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Pinball Fall", DR_MINIGAME_4P, 0x3C, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Pier Pressure", DR_MINIGAME_4P, 0x3D, 0, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_BUTTONS), DR_NO_FLAGS },
  { "10 to Win", DR_MINIGAME_4P, 0x3E, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Deck Dry Bones", DR_MINIGAME_BATTLE, 0x44, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  { "Cheep Cheep Shot", DR_MINIGAME_BATTLE, 0x45, 0, DR_WII_CONTROL(DR_WII_CONTROL_SIDEWAYS_MOTION), DR_NO_FLAGS },
  { "Spike Strike", DR_MINIGAME_BATTLE, 0x46, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
  ...
  { "Blooper Barrage", DR_MINIGAME_BATTLE, 0x4C, 0, DR_WII_CONTROL(DR_WII_CONTROL_POINTER), DR_NO_FLAGS },
