...
static const dr_mp_minigame_t MP1_MINIGAMES[] = {
  ...
  { "Slot Machine", DR_MINIGAME_1P, 0x02, 0x02, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Buried Treasure", DR_MINIGAME_4P, 0x03, 0x03, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  { "Musical Mushroom", DR_MINIGAME_4P, 0x0B, 0x0B, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Pedal Power", DR_MINIGAME_1P, 0x0C, 0x0C, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Crazy Cutter", DR_MINIGAME_4P, 0x0D, 0x0D, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Face Lift", DR_MINIGAME_4P, 0x0E, 0x0E, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Whack-a-Plant", DR_MINIGAME_1P, 0x0F, 0x0F, DR_NO_QUIRKS, DR_FLAG_LUCKY },

  { "Bash 'n' Cash", DR_MINIGAME_1V3, 0x10, 0x10, DR_NO_QUIRKS, DR_FLAG_UNLUCKY },
  { "Bowl Over", DR_MINIGAME_1V3, 0x11, 0x11, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Ground Pound", DR_MINIGAME_1P, 0x12, 0x12, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Balloon Burst", DR_MINIGAME_4P, 0x13, 0x13, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Coin Block Blitz", DR_MINIGAME_4P, 0x14, 0x14, DR_NO_QUIRKS, DR_FLAG_LUCKY },
  { "Coin Block Bash", DR_MINIGAME_1V3, 0x15, 0x15, DR_NO_QUIRKS, DR_FLAG_LUCKY },
  { "Skateboard Scamper", DR_MINIGAME_4P, 0x16, 0x16, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Box Mountain Mayhem", DR_MINIGAME_4P, 0x17, 0x17, DR_NO_QUIRKS, DR_FLAG_LUCKY },
  ...
  { "Tightrope Treachery", DR_MINIGAME_1V3, 0x1F, 0x1F, DR_NO_QUIRKS, DR_NO_FLAGS },

  { "Knock Block Tower", DR_MINIGAME_1P, 0x20, 0x20, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  { "Shy Guy Says", DR_MINIGAME_4P, 0x28, 0x28, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Limbo Dance", DR_MINIGAME_1P, 0x29, 0x29, DR_NO_QUIRKS, DR_NO_FLAGS },
  { "Bombsketball", DR_MINIGAME_2V2, 0x2A, 0x2A, DR_NO_QUIRKS, DR_NO_FLAGS },
  ...
  // 30 unused
  { "Deep Sea Divers", DR_MINIGAME_2V2, 0x31, 0x30, DR_NO_QUIRKS, DR_FLAG_LUCKY },
