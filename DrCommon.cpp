...
QString dr_cores_directory(void)             { return s_coresDir; }
void    dr_set_cores_directory(const QString &path) { s_coresDir = path; }
QString dr_state_directory(void)             { return s_stateDir; }
void    dr_set_state_directory(const QString &path) { s_stateDir = path; }
