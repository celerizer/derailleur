...
dr_error DrRetro::reads8(int8_t *out, size_t addr, bool big_endian)
{
...
dr_error DrRetro::reads16(int16_t *out, size_t addr, bool big_endian)
{
...
dr_error DrRetro::reads32(int32_t *out, size_t addr, bool big_endian)
{
...
dr_error DrRetro::writes8(int8_t val, size_t addr, bool big_endian)
{
...
dr_error DrRetro::writes16(int16_t val, size_t addr, bool big_endian)
{
...
dr_error DrRetro::writes32(int32_t val, size_t addr, bool big_endian)
{
